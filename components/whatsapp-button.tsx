...
const WHATSAPP_MESSAGE = "Hi! I'm interested in your construction services. Could you please provide more information?";
...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {/* Chat bubble tooltip — shows once on load, dismissible */}
      <AnimatePresence>
        {!dismissed && (
          <motion.div
