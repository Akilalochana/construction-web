...
// ── Icon map — DB-ඒකේ string → LucideIcon ────────────────────────────────────
...
function ServicesPage() {
  ...
  // services array-ඒකෙන් order-ඒකට sort වෙලා ඒනවා (API-ඒකෙන්)
  // featured = order 1 (first service) → featured card
  ...
  return (
    <section id="services" className="section-padding bg-background">
      <div className="container mx-auto px-4">
            ...
            return (
              <Link href={`/services/${featured.slug}`} className="contents">
                <motion.div
                  ...
                  {/* Background — DB image → /api/files/... | නැතිනම් /assets/hero.jpg fallback */}
                  <Image
            ...
            return (
              <Link key={service.id} href={`/services/${service.slug}`} className="contents">
                <motion.div className="relative rounded-2xl overflow-hidden group cursor-pointer"
                  ...
                  {/* DB image → /api/files/... | නැතිනම් /assets/hero.jpg */}
                  <Image
        ...
        {/* Stats bar — first service-ඒකේ stats use කරනවා */}
        {featured && (
