...
// ── Type ──────────────────────────────────────────────────────────────────────
// API-ඒකෙන් එන room object shape
type Room = {
  id: number;
  roomKey: string;
  name: string;
...
// ── SSR-safe Canvas ───────────────────────────────────────────────────────────
// Three.js browser-ඒකේ-ම run වෙනවා — SSR-ඒකේ fail වෙනවා
// dynamic import + ssr:false → browser-ඒකේ load වෙනකම් wait කරනවා
...
export default function WalkthroughPage() {
  ...
  // API-ඒකෙන් rooms load වෙනකම් spinner
